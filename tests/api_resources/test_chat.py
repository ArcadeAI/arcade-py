...
class TestChat:
    ...
    @parametrize
    def test_method_completions(self, client: ArcadeEngine) -> None:
        chat = client.chat.completions()
        assert_matches_type(ChatResponse, chat, path=["response"])

    @parametrize
    def test_method_completions_with_all_params(self, client: ArcadeEngine) -> None:
        chat = client.chat.completions(
            frequency_penalty=0,
            logit_bias={"foo": 0},
            logprobs=True,
    ...
    @parametrize
    def test_raw_response_completions(self, client: ArcadeEngine) -> None:
    ...
    @parametrize
    def test_streaming_response_completions(self, client: ArcadeEngine) -> None:
...
class TestAsyncChat:
    ...
    @parametrize
    async def test_raw_response_completions(self, async_client: AsyncArcadeEngine) -> None:
